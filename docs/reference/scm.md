...
| `app_id_secret`             | `string`  | default: `RELEASER_APP_CLIENT_ID`      | Repository secret name holding the GitHub App client ID used by the generated release (CD) workflow.                                                   |
...
| `ci_app_id_secret`          | `string`  | falls back to `app_id_secret`          | Repository secret name holding the GitHub App client ID used by the generated CI workflow (ADL drift PR). Set it to run CI as a different App than CD. |
| `ci_app_private_key_secret` | `string`  | falls back to `app_private_key_secret` | Repository secret name holding the GitHub App private key used by the generated CI workflow.                                                           |
