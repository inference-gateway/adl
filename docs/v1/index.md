...
| [`spec.documentation`](/reference/documentation) | Documentation pages the generated project owns and ships                           |
| [`spec.examples`](/reference/examples)           | Curated examples rendered into the generated `README.md`                           |
| [`spec.acronyms`](/reference/acronyms)           | Acronyms the generator respects when producing identifiers                         |
| [`spec.telemetry`](/reference/telemetry)         | OpenTelemetry traces and metrics instrumentation                                   |
